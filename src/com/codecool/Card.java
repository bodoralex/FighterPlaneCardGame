...
public enum Card {
    ...
    MESSERSCHMITTBF("BF-109 Messer", 640, 12001, 3400, 1000),
    FOCKEWULFTA("Ta-152 Höhenjaeger", 759, 15100, 5217, 1550),
    ...
    BLOHMVOSS141("BV-141 Assymetrical", 368, 10001, 6100, 1500),
    ANTONOVA40("A-40 Tank", 150, 4000, 7804, 150),
    HORTENHO("Ho-229 Flying wing", 977, 16000, 8100, 810),
    SUPERMARINESPITFIRE("Spitfire mk.vb", 595, 11125, 3039, 756),
    HAWKERHURRICANE("Hurricane mk.iic", 547, 10970, 3950, 965),
    GLOSTERGLADIATOR("Gladiator mk.i", 420, 10020, 2088, 650),
    BRISTOLBEAUFIGHTER("Beaufighter mk.x", 515, 5795, 11521, 2000),
    MIKOYANMIG3("MiG-3", 640, 12050, 3600, 820),
    YAKOVLEVYAK7("Yak-7", 495, 9500, 3000, 643),
    POLIKARPOV("Polikarpov I-16", 525, 9700, 2095, 700),
    LAVOCHKINLAGG("LaGG-3", 575, 9700, 3190, 985),
    NAKAJIMA("Ki-43 Hayabusa", 536, 11200, 2925, 760),
    MITSUBISHIZERO("A6M Zero", 660, 10075, 2996, 800),
    ...
    MORANE("Morane Saulnier 406", 486, 10025, 2500, 1015),
    DEWOITINE("Dewoitine DW520", 560, 10050, 2785, 1250),
    ...
    BUFFALO("Brewster Buffalo", 517, 10100, 3247, 670),
    CURTISHAWK("P–36 Hawk", 500, 9967, 2732, 860),
    FOKKER("Fokker D.XXI", 460, 11350, 2000, 930),
    HEINKEL("Heinkel HE-122A0", 488, 8000, 2000, 600),
    MAVAG("Mávag Héja", 530, 10500, 3240, 580),
    JUNKERS88("Junkers JU-88", 510, 9000, 14000, 2430),
    JUNKERS52("Junkers JU-52", 195, 3400, 7000, 1010);
